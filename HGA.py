...
class HGA:
    ...
    fitness_maximization = True
                            # true if you want to maximize self.fitness
                            # false if you want to minimize self.fitness
    ...
    def Init_population(self):
        ...
        for i in range(1,self.popSize):
         for j in range(1,self.genomeLength):
            ...
            rot[0,0]=math.cos(self.theta); rot[0,1]=-math.sin(self.theta);
            rot[1,0]=math.sin(self.theta); rot[1,1]=math.cos(self.theta);
    ...
    #########################################################
        ...
        # Statistical output                                   
        f = open("output.dat", "a")
        f.write(str(generation) + " " + str(fitness_avarage) + "\n")
        f.write("\n")
        f.close()
